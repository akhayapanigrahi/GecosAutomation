...
*
* Description: This class contains code for Customized report which will give us the Fair knowledge of Outputs after Execution..
*
*
*/
...
public class CustomReport extends ResultListener implements IReporter{
	...
	protected PrintWriter createWriter(String outdir) throws IOException {
		...
		return new PrintWriter(new BufferedWriter(new FileWriter(new File(outdir, "GecosCustomTestNGReport.html"))));
	}
	...
	public String printEnvironmentDetails(List<ISuite> suites) throws Exception {
		StringBuffer sb = new StringBuffer();
			...
			String reportLink=buildUrl.replaceAll(buildNo, "ws/target/surefire-reports/GecosExtentReport.html");
			String logLink=buildUrl.replaceAll(buildNo, "ws/target/logs/GecosConsoleLog.txt");
	...
	protected void startHtml(PrintWriter out) {
		...
		out.println("<head>");
		out.println("<title>Gecos Automation Execution Report</title>");
