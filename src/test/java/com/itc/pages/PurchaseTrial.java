...
public class PurchaseTrial extends BasePageObject {
	PurchaseTrial strial = null;

	public PurchaseTrial(WebDriver driver) {
		super(driver);
	}
	...
	public static Logger logger = Logger.getLogger(PurchaseTrial.class);
	...
	By purchaseMnmtLink=By.linkText("Purchase Management");
...
public void purchaseTrial() throws Exception{
...
public boolean isTrialConvetedToPurchase() throws Exception {
	try {
		...
		if (manageFlag) {
			...
			purchaseTrial();
			logger.info("The  trial is purchased and displayed in Purchase management page for the user");
		} else {
