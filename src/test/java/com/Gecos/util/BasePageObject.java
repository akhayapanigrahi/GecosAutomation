...
*
* Description: This class contains all the commonly used methods which will be used for all the pages.
* Common methods related to Window handling, Alert handling, Mouse hover operation, 
* Normal Operations on Web elements, Wait Management etc...
*
*
*/
...
public class BasePageObject {
	...
	public  void mousehover(By theElement) throws Exception{
	...
	/*public  WebElement mousehover(WebElement theElement) {
