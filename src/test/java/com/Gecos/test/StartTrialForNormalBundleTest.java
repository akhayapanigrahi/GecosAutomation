...
import com.Gecos.pages.StartTrialForNormalBundle;
import com.Gecos.util.BaseTestObject;
import com.Gecos.util.ExcelutilObject;

import junit.framework.Assert;

public class StartTrialForNormalBundleTest extends BaseTestObject {

	StartTrialForNormalBundle trial = null;
	...
	public void verifyStartTrialForBESBundle() throws Exception {
		try {
			...
			String email =getValFromExcel(2,3);
			...
			throw new Exception("Failed to Start  trial for Bundle"+ "\n " + e.getLocalizedMessage());
		}
	}
