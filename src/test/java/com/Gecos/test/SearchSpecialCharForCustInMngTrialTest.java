...
import com.Gecos.pages.SearchSpecialCharForCustInMngTrial;
import com.Gecos.util.BaseTestObject;
import com.Gecos.util.ExcelutilObject;

import junit.framework.Assert;

public class SearchSpecialCharForCustInMngTrialTest extends BaseTestObject {

	SearchSpecialCharForCustInMngTrial trial = null;
	...
	public void verifyLogin() throws Exception {
		try {
			...
			trial = new SearchSpecialCharForCustInMngTrial(driver);
	...
	public void verifySpecialCharForCustomername() throws Exception {
		try {
