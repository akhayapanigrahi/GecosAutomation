...
import com.Gecos.pages.AddUserInCCNotification;
import com.Gecos.util.BaseTestObject;
import com.Gecos.util.ExcelutilObject;

public class AddUserInCCNotificationTest extends BaseTestObject {

	AddUserInCCNotification admin = null;
	...
	public void verifyHomePageDisplay() throws Exception {
		try {
			...
			admin = new AddUserInCCNotification(driver);
	...
	public void verifyUserAddedasCC() throws Exception {
		try {
			...
			admin.addUserAsCC(user,appname,appID);
