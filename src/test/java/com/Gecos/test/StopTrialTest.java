...
import com.Gecos.pages.StopTrial;
import com.Gecos.util.BaseTestObject;
import com.Gecos.util.ExcelutilObject;

import junit.framework.Assert;

public class StopTrialTest extends BaseTestObject {

	StopTrial trial = null;
	...
	public void verifyStopTrial() throws Exception {
		try {
			...
			throw new Exception("Failed to Stop trial for user"+ "\n " + e.getLocalizedMessage());
		}
	}
