...
public class StartISVTrialInGecos extends BasePageObject {
	StartISVTrialInGecos strial = null;

	public StartISVTrialInGecos(WebDriver driver) {
		super(driver);
	}
	...
	public static Logger logger = Logger.getLogger(StartISVTrialInGecos.class);
...
public void startISVTrial(String appName, String email) throws Exception{
