...
public class SearchSpecialCharInStartTrial extends BasePageObject {
	SearchSpecialCharInStartTrial strial = null;

	public SearchSpecialCharInStartTrial(WebDriver driver) {
		super(driver);
	}
	...
	public static Logger logger = Logger.getLogger(SearchSpecialCharInStartTrial.class);
	...
	public void clickStartTrials() throws Exception {
...
public boolean isResultDisplayed() throws Exception {
	try {
		...
		startFlag = isElementPresent(startTrialLink);
		if (startFlag) {
