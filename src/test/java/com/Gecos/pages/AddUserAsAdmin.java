...
public class AddUserAsAdmin extends BasePageObject {
	AddUserAsAdmin objLoginPage = null;
	WebDriverWait wait;
	public AddUserAsAdmin(WebDriver driver) {
		super(driver);
	}
	...
	public static Logger logger = Logger.getLogger(AddUserAsAdmin.class);
...
public void addUserAsAdmin(String user, String textToSelect ) throws Exception{
	if(isElementPresent(AddUser_link)){
		 textToSelect=getValFromExcelForUserList(1,3);
...
public void validateUser(String addedUser) throws Exception{
	...
	String expected_user=getValFromExcelForUserList(1,4);
	//for(WebElement users : all_Admin_Users){
